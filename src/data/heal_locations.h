static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PALLET_TOWN - 1] = {MAP_GROUP(PALLET_TOWN), MAP_NUM(PALLET_TOWN), 8, 10},
    [HEAL_LOCATION_ROUTE1 - 1] = {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), 12, 10},
    [HEAL_LOCATION_ROUTE21_NORTH - 1] = {MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH), 12, 21},
    [HEAL_LOCATION_VIRIDIAN_CITY - 1] = {MAP_GROUP(VIRIDIAN_CITY), MAP_NUM(VIRIDIAN_CITY), 24, 21},
    [HEAL_LOCATION_ROUTE22 - 1] = {MAP_GROUP(ROUTE22), MAP_NUM(ROUTE22), 24, 12},
};
